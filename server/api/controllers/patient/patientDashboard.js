...
import {../../api/queries/constants/selectQueries.js
  SELECT_UPCOMING_APPOINTMENTS_DB,
  SELECT_RECENT_MED_REQ_DB,
  SELECT_BILLING_DB,
...
export async function getAppointmentsDashboard(req, res) {
  ...
  try {
    const [rows] = await pool.query(SELECT_UPCOMING_APPOINTMENTS_DB, [
      patientID,
    ]);
