...
import {
  ...
  INSERT_DOCTOR_QUERY,
} from "../api/queries/constants/insertQueries.js.js";
import {
  SELECT_ADDRESSID_QUERY,
  SELECT_PATIENT_FROM_EMAIL_QUERY,
  SELECT_DOCTOR_FROM_EMAIL_QUERY,
} from "../api/queries/constants/selectQueries.js.js";
import { getUserAndRole } from "../api/queries/user/getUserAndRole.js.js";
...
export async function register(req, res) {
  ...
  try {
    ...
    const emergencyInsertResult = await connection.query(
      INSERT_EMERGENCY_CONTACT_QUERY,
      [
